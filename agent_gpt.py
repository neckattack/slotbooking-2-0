...
def agent_respond(user_message, channel="chat", user_email=None):
    ...
    system_prompt = (
        ...
        "Achte bei deinen Antworten IMMER auf eine natürliche, freundliche und übersichtliche Formatierung mit echten Absätzen (durch Leerzeilen getrennt) und – falls sinnvoll – nummerierten oder Aufzählungs-Listen. Antworte so, wie ein Mensch eine E-Mail schreiben würde. Keine technischen Labels, keine HTML-Tags, keine FAQ-Kennzeichnung.\n"
