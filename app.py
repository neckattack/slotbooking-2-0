...
Sei präzise, geschäftlich und hilfreich. Max 220 Wörter."""
        ...
        topics_prompt = (
            ...
            "Verwende nach Möglichkeit die ORIGINAL-Bezeichnungen aus Betreff oder Notizen und ergänze sie nur mit Kontext, der eindeutig aus den Daten hervorgeht. "
            "Allgemeine Labels wie 'Anfrage', 'Auftragsbestätigung' oder 'Rechnung' sind VERBOTEN, wenn nicht mindestens Firma/Marke ODER Ort ODER Datum im Label vorkommt. Formuliere stattdessen z.B. 'Auftragsbestätigung für Coca Cola Job am 11.12.2025 in Berlin, Bestätigung steht noch aus'. "
